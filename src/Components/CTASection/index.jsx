...
export default function CTASection({ data }) {
  return (
    ...
    >
      <div
        className={
          data.topSpacingClass || "cs_height_105 cs_height_lg_75"
        }
      ></div>
      <div className={`container ${data.containerClass || ""}`}>
        <div className={`cs_cta_content ${data.contentClass !== undefined ? data.contentClass : "ms-auto"}`}>
          <h2
          ...
          ></h2>
          {data.subtitle && (
            <p className={data.subtitleClass || "cs_heading_color cs_fs_18 cs_mb_22"}>
              {data.subtitle}
            </p>
          )}
          <Link
